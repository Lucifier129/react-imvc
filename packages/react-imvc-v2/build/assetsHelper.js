 ...
 */
export const getHtmlCssJsFiles = async (dir) => {
...
export const revStaticAssets = async (staticDir) => {
    ...
    await Promise.all(
        files.map(async (filePath) => {
            ...
            await Promise.all([fs.writeFile(fullRevFilePath, fileContent), fs.remove(fullFilePath)])
...
function modifyFilename(inputPath, modifier) {
...
export function getHashFilename(originalPath, contents) {
